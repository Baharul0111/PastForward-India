...
Point your phone at anything Indian — a monument, a lake, a tiger — or just type its name, and PastForward India returns a 58-second vertical documentary about it, narrated, scored and cut like a human editor made it. The reel is built from real archival material: 19th-century photographs, lithographs and survey plates sourced live from Wikimedia Commons and credited with their licences. Only about eight of the fifty-eight seconds are AI-generated video, and those two windows are labelled **HISTORICAL RECONSTRUCTION** on screen and listed by timecode in a "How do we know this?" card. That restraint is the point: the app makes a claim about the past, so it shows its working. Every fact comes from the Wikipedia article it cites; nothing is invented to fill a gap. A first-time subject costs about ninety cents of compute and takes four minutes. Every replay after that is free and instant.
